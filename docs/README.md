...
The stable runtime is React/Vite, FastAPI, Ollama `gemma4:e2b`, Windows SAPI TTS, browser or local Whisper STT, PDF slide images, and a Stack-chan style avatar.
